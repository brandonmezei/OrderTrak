...
{
    public partial class PickingSearch
    {
        [Inject]
        ...
        protected OrderSearchDTO SearchFilters { get; set; } = new() { Page = 1, RecordSize = 50, SortOrder = 1, SortColumn = 1, PickingOnly = true };
        ...
        protected override void OnInitialized()
        {
            ...
            Layout.UpdateHeader("Picking", "Pick inventory to an order.");

            if (PickedID.HasValue)
                Layout.AddMessage($"Order {PickedID} successfully picked.", MessageType.Success);
